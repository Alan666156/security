	...
	public static void atomicStampedReference(){
		...
		new Thread(() -> {
			try {
				...
				System.out.println(Thread.currentThread().getName() + "修改是否成功：" + atomicStampedReference.compareAndSet(100, 200, stamp, stamp + 1) + ", 实际最新值:" + atomicStampedReference.getReference() + "版本号：" + atomicStampedReference.getStamp());
