 ...
 * <p>
 * 实现原理：在CyclicBarrier的内部定义了一个Lock对象，每当一个线程调用await方法时，将拦截的线程数减1，然后判断剩余拦截数是否为初始值parties，如果不是，进入Lock对象的条件队列等待。
...
public class CyclicBarrierDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        cyclicBarrierTest(cyclicBarrier);
    }
     ...
     */
    private static void cyclicBarrierTest(CyclicBarrier cyclicBarrier) throws Exception {
